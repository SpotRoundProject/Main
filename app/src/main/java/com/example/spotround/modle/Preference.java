...
public class Preference {
    private String preference1, preference2, preference3, preference4, preference5, preference6;

    public Preference() {}

    public Preference(String preference1, String preference2, String preference3, String preference4, String preference5, String preference6) {
