                                    ...
                                    FirebaseFirestore.getInstance().collection("Preference/Round/Round 1/").document(doc1.getId())
                                            ...
                                            .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                                ...
                                                public void onSuccess(@NonNull DocumentSnapshot documentSnapshot) {
                                                    ...
                                                    //String first=doc1.getString("first_preference");
                                                    //String second=doc1.getString("second_preference");
                                                    //String third=doc1.getString("third_preference");
                                                    //String forth=doc1.getString("forth_preference");
                                                    //String fifth=doc1.getString("fifth_preference");
                                                    //String sixth=doc1.getString("sixth_preference");
                                                    //String gender=doc1.getString("gender");
                                                    //String cast=doc1.getString("caste");
                                                    //Map<String,Integer>control;
                                                    //Map<String,Integer>control2=new HashMap<String,Integer>();
                                                    //Map<String,Integer>allot=new HashMap<String,Integer>();
                                                    //allot.put("preference1",1);
                                                    //allot.put("preference2",2);
                                                    //allot.put("preference3",3);
                                                    //allot.put("preference4",4);
                                                    //allot.put("preference5",5);
                                                    //allot.put("preference6",6);
                                                    int pref=0;
                                                    int check=0;
                                                    String seat="";
                                                    String type="";
                                                                        ...
                                                                        else
                                                                        {
                                                                            ...
                                                                            if(access!=0)
                                                                            {
                                                                               ...
                                                                               /* update.clear();
                                                                                update.put("gopens",access-1);
                                                                                control.put("gopens",access-1);
                                                                                myp1.put(sixth,control);*/vacancy.get(preference.getPreference5()).setGopens(access-1+"");
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        {
                                                            /*String l="g";
                                                            l=l+cast.toLowerCase();
                                                            l=l+"s";*/
                                                            //System.out.println(l);
                                                            /*access=myp1.get(first).get(l);
                                                            control=myp1.get(first);*/
                                                            access = vacancy.get(preference.getPreference1()).getCasteVacancy(info.getCaste());
                                                            if(access!=0)
                                                            {
                                                                if(seat.equals(""))
                                                                {
                                                                    ...
                                                                    myp1.put(first,control);
                                                                    control2=control;*/
                                                                    vacancy.get(preference.getPreference1()).DecCasteVacancy(preference.getPreference1());
                                                                }
                                                                if(seat.equals(preference.getPreference1()))
                                                                {
                                                                    ...
                                                                    myp1.put(first,control);*/
                                                                    vacancy.get(preference.getPreference1()).DecCasteVacancy(info.getCaste());
                                                                }
                                                                else if(!seat.equals(""))
                                                                {
                                                                    /*int solve=control2.get(type);
                                                            ...
                                                            else
                                                            {
                                                                ...
                                                                if(access!=0)
                                                                {
                                                                    if(seat.equals(""))
                                                                    {
                                                                        ...
                                                                        myp1.put(second,control);
                                                                        control2=control;*/
                                                                        vacancy.get(preference.getPreference2()).DecCasteVacancy(info.getCaste());
                                                                    }
                                                                    else if(seat.equals(preference.getPreference2()))
                                                                    {
                                                                        /*int solve=control2.get(type);
                                                                ...
                                                                else
                                                                {
                                                                    ...
                                                                    control=myp1.get(third);*/
                                                                    access=vacancy.get(preference.getPreference3()).getCasteVacancy(info.getCaste());
                                                                    if(access!=0)
                                                                    {
                                                                        if(seat.equals(""))
                                                                        {
                                                                            ...
                                                                            myp1.put(third,control);
                                                                            control2=control;*/
                                                                            vacancy.get(preference.getPreference3()).DecCasteVacancy(info.getCaste());
                                                                        }
                                                                        else if(seat.equals(preference.getPreference3()))
                                                                        {
                                                                            /*int solve=control2.get(type);
                                                                    ...
                                                                    else
                                                                    {
                                                                        ...
                                                                        control=myp1.get(forth);*/
                                                                        access = vacancy.get(preference.getPreference4()).getCasteVacancy(info.getCaste());
                                                                        if(access!=0)
                                                                        {
                                                                            if(seat.equals(""))
                                                                            {
                                                                                ...
                                                                                myp1.put(forth,control);
                                                                                control2=control;*/
                                                                                vacancy.get(preference.getPreference4()).DecCasteVacancy(info.getCaste());
                                                                            }
                                                                            else if(seat.equals(preference.getPreference4()))
                                                                            {
                                                                                /*int solve=control2.get(type);
                                                                        ...
                                                                        else
                                                                        {
                                                                            ...
                                                                            control=myp1.get(fifth);*/
                                                                            access = vacancy.get(preference.getPreference5()).getCasteVacancy(info.getCaste());
                                                                            if(access!=0)
                                                                            {
                                                                                if(seat.equals(""))
                                                                                {
                                                                                    ...
                                                                                    myp1.put(fifth,control);
                                                                                    control2=control;*/
                                                                                    vacancy.get(preference.getPreference5()).DecCasteVacancy(info.getCaste());
                                                                                }
                                                                                else if(seat.equals(preference.getPreference5()))
                                                                                {
                                                                                    /*int solve=control2.get(type);
                                                                            ...
                                                                            else
                                                                            {
                                                                                ...
                                                                                control=myp1.get(sixth);*/
                                                                                access = vacancy.get(preference.getPreference6()).getCasteVacancy(info.getCaste());
                                                                                if(access!=0)
                                                                                {
                                                                                    if(seat.equals(""))
                                                                                    {
                                                                                        ...
                                                                                        myp1.put(sixth,control);
                                                                                        control2=control;*/
                                                                                        vacancy.get(preference.getPreference6()).DecCasteVacancy(info.getCaste());
                                                                                    }
                                                                                    else if(seat.equals(preference.getPreference6()))
                                                                                    {
                                                                                        /*int solve=control2.get(type);
                                                        ...
                                                        if(!info.getCaste().equals("Open")&&info.getGender().equals("F"))
                                                        {
                                                            ...
                                                            else
                                                            {
                                                                /*access=myp1.get(second).get(l);
                                                                control=myp1.get(second);*/
                                                                access = vacancy.get(preference.getPreference2()).getCasteVacancy(info.getCaste());
                                                                if(access!=0)
                                                                {
                                                                    if(seat.equals(""))
                                                                    {
